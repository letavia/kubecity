...
sudo rm -Rf /var/lib/glusterd /etc/glusterfs \
...
gcloud compute ssh gke-kubelandia-kubelandia-pool-fbcf4a2c-8d4d
gke-kubelandia-kubelandia-pool-fbcf4a2c-gkwt
gke-kubelandia-kubelandia-pool-fbcf4a2c-ml8w
